...
def read_file(file):
    ...
    productions = [] #Array para guardar todas líneas debajo del encabezado PRODUCTIOS
        ...
        if line[:9] == "COMPILER ":     #Primera linea del compiler, se toma su nombre
            ...
            if (not(line == chr(10)) and not(line[4:] == nameATG)):
                ...
                if line.strip() in ["CHARACTERS", "KEYWORDS", "TOKENS", "PRODUCTIONS"]:  #Si la linea es un encabezado se cambia el valor de flag
                    ...
                    if flag == 4: 
                        productions.append(lineStripped)
    text_file.close()
    return characters, keywords, tokens, productions, nameATG 